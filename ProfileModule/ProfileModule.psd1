@{
    ...
    FunctionsToExport   = @('Invoke-Greeting', 'uptime', 'touch', 'unzip', 'grep', 'df', 'sed', 'which', 'export', 'pkill', 'pgrep', 'Install-AzureCLI', 'Get-UTCTime', 'Set-EnvVar', 'Remove-EnvVar', 'Test-IsAdmin', 'Start-AsAdmin', 'New-PSProfile', 'Get-CommandInfo', 'Show-ApprovedVerbs', 'Write-PSVersionTable', 'Show-TermColors', 'Lock-Machine', 'Show-ProfileModuleFunctions', 'Show-ProfileModuleAliases', 'Restart-Shell', 'Show-PSProfilePaths', 'Get-OpenIPAddress', 'Get-PublicIP', 'Get-HTTPSiteAvailable', 'Get-ParentPath', 'Edit-Profile', 'New-SymLink', 'Find-File', 'Unlock-DownloadedFile', 'Update-PSModules', 'New-SelfSignedCert', 'Install-ScoopCli', 'Initialize-ScoopCli', 'Install-Winget', 'Start-WinGetUpdate')
