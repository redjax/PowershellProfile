@{
	...
	RootModule = 'MSOutlookHelpers.psm1'
	...
	# RequiredAssemblies = @('bin\MSOutlookHelpers.dll')
	
	# Type files (.ps1xml) to be loaded when importing this module
	# Expensive for import time, no more than one should be used.
	# TypesToProcess = @('xml\MSOutlookHelpers.Types.ps1xml')
	
	# Format files (.ps1xml) to be loaded when importing this module.
	# Expensive for import time, no more than one should be used.
	# FormatsToProcess = @('xml\MSOutlookHelpers.Format.ps1xml')
