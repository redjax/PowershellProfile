@{
    ...
    Author              = 'redjax'
    FunctionsToExport   = @('Test-IsAdmin', 'Lock-Machine', 'Restart-ShellSession', 'Show-InstalledApps', 'Show-DiskUsage', 'Remove-EnvVar', 'Set-EnvVar', 'Get-PowershellVersion', 'New-PSProfile', 'Show-ApprovedVerbs', 'Show-PSProfilePaths', 'Show-TermColors', 'Write-PSVersionTable', 'Show-ModulesInSession', 'Show-ProfileModuleAliases', 'Show-ProfileModuleFunctions', 'Update-PSModules', 'Test-ValidPackageManager', 'Install-Winget', 'Start-WinGetUpdate', 'Install-NerdFont', 'Start-StarshipShell', 'Open-YaziHelp', 'y')
