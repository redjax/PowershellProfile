@{
    ...
    Author              = 'redjax'
<<<<<<< HEAD
    FunctionsToExport   = @('Install-AzureCLI', 'Get-InstalledApps', 'Show-InstalledApps', 'Unlock-BitwardenVault', 'Get-UTCTime', 'Get-TS', 'Get-DiskUsage', 'Set-EnvVar', 'Remove-EnvVar', 'Test-IsAdmin', 'Start-AsAdmin', 'New-PSProfile', 'Get-PowershellVersion', 'Start-StarshipShell', 'Get-CommandInfo', 'Show-ApprovedVerbs', 'Write-PSVersionTable', 'Show-TermColors', 'Lock-Machine', 'Show-ProfileModuleFunctions', 'Show-ProfileModuleAliases', 'Restart-ShellSession', 'Show-PSProfilePaths', 'Get-RandomUAString', 'Show-ModulesInSession', 'Get-OpenIPAddress', 'Get-PublicIP', 'Get-HTTPSiteAvailable', 'Start-Ping', 'Get-ParentPath', 'Get-ProfileDir', 'Switch-ToProfilePath', 'Edit-Profile', 'New-SymLink', 'Find-File', 'Unlock-DownloadedFile', 'Update-PSModules', 'New-SelfSignedCert', 'Convert-ToLowercase', 'Convert-ToUppercase', 'Convert-ToTitlecase', 'Get-NewGuid', 'Install-ScoopCli', 'Initialize-ScoopCli', 'Install-Winget', 'Start-WinGetUpdate', 'y', 'Open-YaziHelp', 'Get-Weather', 'uptime', 'touch', 'unzip', 'grep', 'df', 'sed', 'which', 'export', 'pkill', 'pgrep')
